...
public class LC1102PathWithMaximumMinimumValue {
    ...
    public int maximumMinimumPath(int[][] A) {
        ...
        /*
        in the BFS approach, for each step, we are interested in
        getting the maximum min that we have seen so far, thus we reverse the ordering in the pq
         */
